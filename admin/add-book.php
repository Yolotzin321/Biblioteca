...
<div class="col-md-6">  
<div class="form-group">
<label>Número de ISBN<span style="color:red;">*</span></label>
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Catalogación<span style="color:red;">*</span></label>
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Imágen del Libro<span style="color:red;">*</span></label>
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Libros Existentes (cantidad)<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="bqty" autocomplete="off"   required="required" />
 </div>
</div>
<div class="col-md-12"> 
<button type="submit" name="add" id="add" class="btn btn-info">Agregar </button>
</div>
 </div>
</div>
                            </div>
